...
namespace {
  ...
  constexpr Score BackRankBlocked = S(20, 20);
  ...
  Score evaluate(const Position& pos, Pawns::Entry* e) {
    ...
    constexpr Bitboard  BackRanks = (Us == WHITE ? Rank2BB | Rank3BB : Rank7BB | Rank6BB);
    ...
    while ((s = *pl++) != SQ_NONE)
    {
        ...
        if(blocked && (BackRanks & s))
            score -= BackRankBlocked;
    }
