...
namespace {
  ...
  void Evaluation<T>::initialize() {
    ...
    // Squares occupied by those pawns, by our king, or controlled or occupied by enemy pawns
    // are excluded from the mobility area.
    mobilityArea[Us] = ~(b | pos.square<KING>(Us) | pe->pawn_attacks(Them) | pos.pieces(Them, PAWN));
